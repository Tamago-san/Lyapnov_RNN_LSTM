...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine rc_traning_own_fortran(in_node,out_node,rc_node,traning_step,rc_step,gusai,alpha,g,&
                    u_traning,s_traning,u_rc,w_in,a,w_out)
    implicit none
    integer(4), intent(inout) :: in_node,out_node,rc_node,traning_step,rc_step
    real(8),    intent(inout) :: gusai,alpha,g
    real(8),    intent(inout) ::u_traning(traning_step,in_node) !今は一次元、列サイズはトレーニング時間
    real(8),    intent(inout) ::s_traning(traning_step,out_node)  !出力次元数、列サイズはトレーニング時間
...
!    real(8)     a(rc_node,rc_node)
    real(8)    s_test(traning_step,out_node)
...
!    do i=1,rc_step
!        write(54,*) i, s_test(i,1:out_node)
!    enddo
!    close(54)
    contains
