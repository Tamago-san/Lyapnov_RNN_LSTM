...
set title time
plot filename using 1 title "output(RNN)" with lines lc 15 lw 4,filename2 using 2 title "original" with lines lc 6 lw 2,filename2 using 3 title "input" with lines lt 0 lc 8 lw 0.2
